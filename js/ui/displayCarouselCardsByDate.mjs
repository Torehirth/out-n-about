...
export const displayCarouselCardsByDate = (container, posts, numberOfPosts) => {
  ...
  // using the slice(start, end) method to change the number of posts I want to display in the carousel.
  ...
  limitedPosts.forEach((post) => {
    ...
    const img = createPostImage(post, "post-carousel-card-img", "medium_featured");
